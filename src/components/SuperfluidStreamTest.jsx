...
import SwapWidgetTest from "./../bridges/SwapbridgeTest";
import WidgetSwapTest from "./../bridges/BridgeswapTest";
...
const SuperfluidStreamTest = () => {
    ...
    function SwapButton({ isLoading, children, ...props }) {
      return (
          <Button variant="success" className="button" {...props}>
              {isButtonLoading ? <Spinner animation="border" /> : children}
          </Button>
    ...
    return (
      <div>
       ...
       <div><h1>My Wallet Balance is:</h1></div>
       <div>
         <h2>Create a Flow</h2>
       </div>
       <div>
...
export default SuperfluidStreamTest;
